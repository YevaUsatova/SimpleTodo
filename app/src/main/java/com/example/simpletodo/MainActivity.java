...
public class MainActivity extends AppCompatActivity {
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               String todoItem = etItem.getText().toString();
                ...
                items.add(todoItem);
                // Notify adapter that the item is added
    ...
    //This function will load items by reading every line on the data file
    private void loadItems() {
        try {
            items = new ArrayList<>(org.apache.commons.io.FileUtils.readLines(getDataFile(), String.valueOf(Charset.defaultCharset())));
        } catch (IOException e) {
